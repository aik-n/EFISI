...
def test_process(opt, critertion, cl_model, test_loader, last_F1=None, last_Accuracy=None, log_summary_writer: SummaryWriter=None, epoch=None):
    y_true = []
    y_pre = []
    total_labels = 0
    test_loss = 0
    ...
    with torch.no_grad():
        ...
        for index, data in enumerate(test_loader_tqdm):
            ...
            origin_res, _, _ = cl_model(orgin_param)
        ...
        with open('predict_test.txt', 'w', encoding='utf-8') as fout:
