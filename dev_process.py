...
count = 0
def dev_process(opt, critertion, cl_model, dev_loader, test_loader, last_F1=None, last_Accuracy=None, train_log=None, log_summary_writer:SummaryWriter=None):
    y_true = []
    y_pre = []
    total_labels = 0
    dev_loss = 0
    ...
    with torch.no_grad():
        ...
        if last_F1 is not None:
            ...
            return last_F1, last_Accuracy, dev_accuracy, dev_F1_weighted